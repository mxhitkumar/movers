	...
	(function(e, t) {
		...
		var l = {
			...
			// 		}
				...
				// 		}),
				// 		o.loadJS({
				// 			file: "https://www.googletagmanager.com/gtag/js?id=G-#",
				// 			id: "canvas-gtag-js",
				// 		}),
								...
								(y(),
									...
									.then(function(e) {
										...
										(e?.classList.add("d-none"),
											...
											.length < 1) ?
										b(): (N.imagesLoaded(N.getVars.portfolioAjax.container),
									...
									(N.initFunction({
										...
										(t.each(function() {
												...
												if (
													...
													for (
														var r, a = a.split(","), s = "", s = 0; s < a.length; s++
													)
														(r = Number(a[s]) - 1),
